...
--
-- Host: mysql
-- Creato il: Mag 15, 2026 alle 08:36
...
(109, 1, 2, 'ciao', '172.21.0.1', '2026-04-28 07:00:15', 0),
...
(64, 1, 6, '2026-04-28 09:12:50'),
(65, 1, 5, '2026-05-08 11:44:41');
...
(1, 'Mattia', 'Giancristofaro', 'purplehaze', 'via lago di garda 7', '2008-01-14', 'VENEZIA', 'VENEZIA', 'VETF04000T', '5', '3396344400', 'mgiancry@gmail.com', '$2y$10$JDMzCYP.N/k0Z5.V58LVYeswhdUpx10uQ5ncgSKkjNeB93aFCked6'),
...
--
ALTER TABLE `messaggi`
  MODIFY `idMessaggio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;

--
-- AUTO_INCREMENT per la tabella `stress_log`
--
ALTER TABLE `stress_log`
  MODIFY `id_stress` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
